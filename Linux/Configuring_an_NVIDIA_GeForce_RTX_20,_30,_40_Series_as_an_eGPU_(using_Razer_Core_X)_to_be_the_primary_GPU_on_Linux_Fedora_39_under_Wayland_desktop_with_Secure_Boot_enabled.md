# Configuring an NVIDIA GeForce RTX 20, 30, 40 Series as an eGPU (using Razer Core X) to be the primary GPU on Linux Fedora 39 under Wayland desktop with Secure Boot enabled
